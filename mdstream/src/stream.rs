...
use crate::syntax::facts::{
    code_fence_suffix, count_double_dollars, fence_end, fence_start,
    is_atx_heading_start as is_heading, is_blank_line as is_empty_line, is_blockquote_start,
    is_list_continuation, is_list_item_start, is_list_item_start_prefix, is_thematic_break,
